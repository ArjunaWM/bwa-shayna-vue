                    ...
                    <tbody>
                      ...
                      <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                        ...
                        <td @click="removeItem(keranjangUser.index)" class="delete-item">
                          <a href="#"><i class="material-icons"><router-link to="/cart" style="color: black;">close</router-link></i></a>
                        </td>
                      </tr>
              ...
              <div class="col-lg-12">
                <div class="proceed-checkout text-left">
                  <ul>
                    ...
                    <li class="subtotal mt-3">Pajak <span>${{ pajakHarga }} (10%)</span></li>
...
export default {
  ...
  computed: {
    ...
    totalBiaya() {
      return this.subTotal + this.pajakHarga;
    }
  }
};
</script>
